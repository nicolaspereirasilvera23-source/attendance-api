# WORKFLOW FRONTEND - AGENTE

Este documento define el flujo de trabajo, responsabilidades y criterios de aceptación para el **Agente de Turno**, encargado de liderar y desarrollar el **Frontend en React + TailwindCSS + Vite + PWA** del sistema Suarez Voley Club.
